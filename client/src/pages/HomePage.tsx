...
export default function HomePage() {
  ...
  return (
    <Layout>
      ...
      <section className="smst-section bg-white homepage-text">
...
<br/><p className='m-4 '>"What do you think of Subbaramaiah? He is a great Mahatma (Sadguru) who has served two great Mahatmas" as praised by Sri Ekkirala Bharadwaja Master. The same 'Pesala Subbaramaiah' fondly called as 'SIR' by His devotees is the founder of 'Sai Master Seva Trust'. Even after His MahaSamadhi in 2017, the manner in which HE runs this Trust and protects His devotees by guiding them in the Righteous path is amazing. To know more about His Life, Preachings and the Divine Experiences bestowed upon His devotees, please check the 'Books and Downloads' section...<br/>
</p>


<p className='m-4 font-bold'>Sai	Swamy	Master
శ్రీ శిరిడీ సాయిబాబా
శ్రీ వెంకయ్య స్వామి
శ్రీ ఎక్కిరాల భరద్వాజ</p>

     <p className='m-4'>దీనజనోద్ధరణ కొరకు, భక్త సంరక్షణ కొరకు, ముముక్షువులకు మార్గం చూపడానికి ఆ పరమాత్మ మన మధ్య సద్గురువుగా అవతరిస్తారు. అట్టి సద్గురువులలో శాస్త్రాలలో నిర్దేశించబడిన సర్వవ్యాపకత్వం, సర్వసమర్ధత, సర్వజ్ఞత్వాలు సంపూర్ణముగా ప్రకటమవుతాయి. అలా ప్రకటమయినవారే గొలగమూడిలో వెలసిన అవధూత శ్రీ వెంకయ్యస్వామివారు.
