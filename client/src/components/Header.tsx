        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center gap-3">
              ...
              <button className="bg-orange-500 text-white px-6 py-2 rounded-lg font-bold hover:bg-orange-600 transition-all duration-300 shadow-md hover:shadow-lg hover:scale-105 transform">
                ❤️ Donate Now
              </button>
            </div>
          ...
          {mobileMenuOpen && (
            <nav className="md:hidden mt-4 flex flex-col gap-2 animate-in fade-in slide-in-from-top-2">
              ...
              <button className="bg-orange-500 text-white px-6 py-2 rounded-lg font-bold hover:bg-orange-600 transition-all w-full mt-2 shadow-md hover:shadow-lg">
                ❤️ Donate Now
              </button>
            </nav>
          )}
